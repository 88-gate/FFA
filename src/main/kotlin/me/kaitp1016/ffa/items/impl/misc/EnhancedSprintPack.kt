...
object EnhancedSprintPack: CustomItem() {
    override val id = "ENHANCED_SPRINT_PACK"
    override val name = "Enhanced Sprint Pack"
    ...
    override fun createItem(amount: Int): ItemStack {
        return super.createItem(amount).asCraftItemStack().handle.apply {
            ...
            this.set(DataComponents.CUSTOM_NAME, this@EnhancedSprintPack.getDisplayName().toMCComponent())
        }.bukkitStack
    }
